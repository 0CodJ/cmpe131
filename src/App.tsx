...
function MainApp() {
  ...
  const [searchKeywords, setSearchKeywords] = useState<string>(''); // Store active keyword search text (used for filtering)
  const [keywordInput, setKeywordInput] = useState<string>(''); // Store what user is typing (not used for filtering until search is triggered)
  ...
  const extractTitle = (text: string): string => {
    ...
    // More flexible fallback: allow natural sentence endings within a reasonable range
    // If the text is reasonably short (< 250 chars), return it as is
    if (text.length <= 250) {
      return text.trim();
    }
    
    // Look for natural sentence endings (. ! ?) in the 150-250 character range
    const flexibleRange = text.substring(150, 250);
    const sentenceEndMatch = flexibleRange.match(/[.!?]\s/);
    if (sentenceEndMatch && sentenceEndMatch.index !== undefined) {
      const endIndex = 150 + sentenceEndMatch.index + 1; // +1 to include the punctuation
      return text.substring(0, endIndex).trim();
    }
    
    // No natural ending found, truncate at 200 characters
  ...
  // Keyword-based categorization system. Checks event info checks if words match to assign a category. 
  const categoryKeywords: Record<string, string[]> = {
    "Politics": [
    "activism", "advocacy", "alliance", "amendment", "ambassador", "annexation",
    "anarchism", "aristocracy", "assembly", "authoritarianism",
    "bill", "borders",
    "cabinet", "capitalism", "charter",
    "chancellor", "censorship", "citizenship", "civil rights", "civil unrest",
    "colony", "colonialism", "communism", "confederation", "congress", "constitution",
    "conservatism", "corruption", "council", "coup",
    "decree", "decolonization", "democracy", "demonstration", "diplomat", "dissolution",
    "dynasty",
    "election", "embargo", "embargoed", "embargoes", "embargoing", "empire", "executive order",
    "fascism", "federation",
    "geopolitics", "governance", "government", "governor",
    "human rights",
    "immigration", "impeachment", "inauguration", "independence",
    "judiciary", "jurisdiction",
    "kingdom",
    "law", "legislation", "liberalism",
    "mandate", "mayor", "ministry", "monarchy",
    "nationalism", "nation", "negotiation",
    "oligarchy", "oversight",
    "pact", "parliament", "plebiscite", "policy", "populism",
    "president", "prime minister", "proclamation", "propaganda",
    "protest", "protested", "protesting", "protests", "public service",
    "referendum", "regulation", "republic", "resolution", "revolution",
    "secession", "senate", "socialism", "sovereignty", "statecraft", "succession",
    "sanction", "sanctioned", "sanctioning", "sanctions",
    "Supreme Court",
    "taxation", "totalitarianism", "transparency", "treaty",
    "uprising", "unification",
    "veto", "vetoed", "vetoes", "vetoing",
    "welfare"
  ],

  "Science": [
    "adaptation", "anatomy", "asteroid", "astrobiology", "astronomy", "atmosphere", "atom",
    "biodiversity", "biology", "biophysics", "biotechnology", "black hole", "botany",
    "cell", "chemistry", "climate", "climate change", "comet", "compound", "conservation",
    "DNA", "diagnosis",
    "ecology", "evolution", "epidemiology",
    "experiment", "experimented", "experimenting", "experiments",
    "fieldwork", "genetics", "genome", "geology", "gravity",
    "hypothesis",
    "laboratory",
    "magnetism", "materials science", "mathematics", "medicine", "meteor",
    "microbiology", "microscope", "molecule",
    "nebula", "nanotechnology", "number theory",
    "observatory", "observatories", "optics", "organism",
    "particle", "pathology", "physics", "planetary science",
    "quantum",
    "radiation", "reaction", "relativity", "renewable energy", "robotics", "RNA",
    "satellite", "spacecraft", "space exploration", "space station", "space shuttle",
    "species", "specimen", "supernova",
    "telescope", "telescopes", "tectonics", "theory", "thermodynamics",
    "vaccine", "volcano", "wave"
  ],

  "Economics": [
    "banking", "bankruptcy", "bond", "budget deficit",
    "capitalism", "central bank", "commerce", "commercial trade",
    "competition", "consumerism", "corporation", "credit", "currency",
    "debt", "deflation", "demand", "depression",
    "economic collapse", "economic growth", "economic policy", "economic recovery",
    "economist", "economy", "exchange rate", "export controls", "exports",
    "finance", "fiscal policy", "free market",
    "GDP", "globalization",
    "imports", "import restrictions", "industrialization",
    "inflation", "inflation rate", "interest rates", "investment",
    "labor", "living wage",
    "merchants", "minimum wage", "monetary policy", "monopoly",
    "market crash", "market crashes", "market crashing",
    "nationalization",
    "oligopoly",
    "privatization", "profit",
    "recession",
    "stagflation", "stock market", "subsidies", "supply", "surplus",
    "tariffs", "taxation", "trade", "trade route", "traded", "trades", "trading",
    "unemployment",
    "wages", "Wall Street"
  ],
  ...
  "Military": [
    ...
    "ammunition", "army", "armistice", "armored division",
    "artillery",
    "assault", "assaulted", "assaulting", "assaults",
    "battle", "battled", "battles", "battling", "battleship",
    "biological weapons",
    "bomb", "bombed", "bombing", "bombs",
    "bunkers",
    "captain", "carrier", "cavalry", "ceasefire",
    "chemical weapons", "codebreaking", "colonel",
    "commander", "commandos", "conflict", "conscription", "counterinsurgency",
    "defensive", "demilitarization", "deployment",
    "encryption", "enlistment", "espionage",
    "fighter", "firearm", "fortifications", "formation",
    "general", "guerrilla",
    "helicopter",
    "infantry", "insurgency", "intelligence", "invasion",
    "Japanese forces",
    "jet",
    "liberation", "lieutenant", "logistics",
    "maneuver", "marines", "mercenary", "militia", "missile",
    "mobilization",
    "naval fleet", "navy", "nuclear weapons",
    "occupation", "occupation forces", "offensive",
    "operation",
    "paratroopers", "peace treaty", "pistol",
    "radar", "raid", "raided", "raiding", "raids",
    "reconnaissance", "retreat", "retreated", "retreating", "retreats",
    "rifle", "rocket",
    "sabotage", "sabotaged", "sabotages", "sabotaging",
    "sergeant", "siege",
    "skirmish", "skirmished", "skirmishing", "skirmishes",
  ...
  "People": [
    ...
    "activism", "advocacy",
    "adulthood", "apprenticeship", "assassination", "authorship", "awards",
    "biography", "birth", "breakthrough", "burial",
    "career", "charity", "childhood", "collaboration", "composition",
    "coronation", "creations", "creativity",
    "debate", "debated", "debates", "debating",
    "death", "discoveries", "divorce", "downfall",
    "education", "exile",
    "honors", "humanitarian work",
    "illness", "inauguration", "influence", "innovation", "inspiration",
    "kingship",
    "leadership", "legacy",
    "marriage", "mentorship", "migration",
    "partnership", "performance", "philosophy", "pilgrimage", "presidency",
    "public service",
    "recognition", "recovery", "resistance",
    "retirement", "rivalry", "rulership",
    "scholarship",
    "serial killer", "serial killers", "serial killing",
    "speech",
    "teachings", "training",
    "writings"
  ],
  ...
  "Technology": [
    "AI", "algorithm", "algorithms", "architecture",
    "augmented reality", "automation",
    "battery", "bioengineering", "blockchain", "blueprint",
    "chip", "circuit", "cloud computing", "code", "computer", "console",
    "cryptography", "cybersecurity",
    "database", "deep learning",
    "electricity", "encryption", "engines", "engineering", "ethernet",
    "fabrication", "fiber optics", "firmware",
    "generators",
    "hardware",
    "industrial machinery", "internet", "invention", "innovation", "IoT",
    "lander",
    "machine learning", "maintenance", "manufacturing", "memory", "microchip",
    "mobile device", "motherboard", "MRI",
    "nanotechnology", "networking", "neural networks", "nuclear energy",
    "observatory", "observatories", "operating system",
    "patent", "power grid", "processors", "programming", "prototype",
    "quantum computing",
    "railway",
    "renewable energy",
    "rover", "robotics", "rocket",
    "satellite", "sensors", "semiconductor", "smartphone", "software",
    "solar panels", "space observatory", "space observatories",
    "space station", "space telescope", "space telescopes", "spacecraft",
    "storage",
    "telecommunications", "telescope", "telescopes", "transportation",
    "transistor", "turbines",
    "upgrade", "upgraded", "upgrades", "upgrading", "user interface",
    "versioning", "virtual reality",
    "wireless",
    "X-ray",
    "3D printing"
  ]
  ...
  // Reset keyword search when date, year, or category changes
  useEffect(() => {
    setSearchKeywords('');
    setKeywordInput('');
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2">
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter') {
                    setSearchKeywords(keywordInput);
                  }
                }}
                ...
                className="flex-1 px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
              />
              <button
                onClick={() => setSearchKeywords(keywordInput)}
                className="px-4 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors flex items-center justify-center"
                aria-label="Search"
              >
