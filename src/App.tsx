...
function MainApp() {
  ...
  const categories = ['all', 'General', 'Politics', 'Science', 'Economics', 'Military, S', 'People', 'Technology'];
  ...
  const categoryKeywords: Record<string, string[]> = {
    ...
    Economics: [
      ...
      "interest rates", "credit", "debt", "bond", "stock market", "stock market crash", "boom", "GDP",
    ...
    Military: [
      ...
      "helicopter", "jet", "fighter", "submarine", "battleship", "carrier",
